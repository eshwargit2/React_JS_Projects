...
import './Chat1.css'
import img1 from './imgs/yuvan sankar raj.jpg'
...
const Chat7 = () => {
    ...
    const contact = () =>{
       ...
       return (
         <div>
            {chat ==='home_con' && (
             <div className="container" id='chat7'>
                 <div className="row">
                   ...
                   <div className='chat-msg-container'>
                     ...
                     <div className="container   ">
                       <div className="row">
                         ...
                         <div className="col-7 text-white text-center"><h4 className='mt-3'>Yuvan sankar</h4></div>
