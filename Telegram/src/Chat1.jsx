...
import './Chat1.css'
import img1 from './imgs/elon.webp'
...
const contact = () =>{
  ...
  return (
    <div >
       {chat ==='home_con' && (
        <div className="container" id='chat1'>
            <div className="row">
              ...
              <div className='chat-msg-container'>
                ...
                <div className="container">
                  <div className="row">
                    ...
                    <button className='btn' onClick={view_cat} ><Leftarrow/></button>
                    </div>
                    <div className="col-2  ">
                         <img src={img1} alt="...." className='img1 mt-1 ' width={20}  />
                         
                    </div>
                    <div className="col-6 text-white"><h4 className='mt-3'>Elon musk</h4></div>
